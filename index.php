...
<html lang="fr" data-bs-theme="light">
	<head>
		...
		<title>Lucas Spitzer - Portfolio Étudiant</title>
		<link rel="shortcut icon" type="image/x-icon" href="img/favicon.ico" />
		<meta name="description" content="Lucas Spitzer, étudiant en terminale STI2D option SIN" />
		<!-- Bootstrap -->
	...
	<body>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-body fixed-top">
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarNav">
						...
						<a class="btn btn-dark fw-bold" href="https://blog.lucasspitzer.me">Blog</a>
					</div>
				</div>
			</nav>
		</header>
				...
				<div class="container col-xxl-8 px-4 py-5">
					<div class="row flex-lg-row-reverse align-items-center g-5 py-5">
						<div class="col-10 col-sm-8 col-lg-6">
							<img src="img/logo.png" class="d-block mx-lg-auto img-fluid rounded-circle profil" alt="Photo de profil représentant un lapin avec un casque d'astronaute en blanc et bleu" width="700" height="500" loading="lazy" />
						</div>
						<div class="col-lg-6">
		...
		<section class="container p-2 d-flex flex-column min-vh-100 justify-content-center align-items-center" id="competences">
		...
		<section class="container p-2 d-flex flex-column min-vh-100 justify-content-center align-items-center" id="projets">
			<h1 class="text-center pb-4 fw-bold">Projets</h1>
			<div class="row row-cols-1 row-cols-md-3 g-4">
				...
				<div class="col">
					<div class="card h-100">
						<img src="img/portfolio-mockup.webp" class="card-img-top" alt="Vue du site actuel sur un écran d'ordinateur" />
						<div class="card-body">
							<span class="card-title h5"><a href="/">Portfolio</a></span>
							<div class="card-text">
								<p>Création d'un nouveau portoflio avec le framework Bootstrap et un formulaire de contact en PHP</p>
							</div>
						</div>
						<div class="card-footer">
							<small class="text-body-secondary">Avril 2023 - Projet Personnel</small>
						</div>
					</div>
				</div>
				<!-- EASY ACCESS-->
		...
		<div class="imageseparation3 mb-5 skewed"></div>
		<!-- SECTION 4 - CONTACT-->
		...
		<div class="container">
			<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
				<p class="col-md-4 mb-0 text-body-secondary">&copy; 2023 Lucas Spitzer</p>
